...
export function ProjectContextProvider({
  ...
  const {
    ...
    getProjectFileNotifications: getProjectFileNotificationsRequest,
    getViewport: getViewportRequest,
    getFlatUserProjects: getUserProjectsRequest,
    acceptResourcesShare: acceptShareRequest,
    ...
    getSharedWithMeResources: getSharedWithMeFilesRequest,
  } = useApiRequests();
  const {
    clearTablesData,
    viewGridData,
  ...
  const cloneProjectModal = useRef<CloneModalRefFunction | null>(null);
  ...
  const cloneCurrentProject = useCallback(
    async ({
      ...
      if (!silent) {
        cloneProjectModal.current?.(_projectState.current.projectName);
  ...
  const updateProjectList = useCallback((projectList: ResourceMetadata[]) => {
  ...
  return (
    <ProjectContext.Provider value={value}>
      ...
      <CloneProject cloneProjectModal={cloneProjectModal} />
