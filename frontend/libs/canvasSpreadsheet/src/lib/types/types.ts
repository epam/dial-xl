...
export type CanvasOptions = {
  enableMoveTable?: boolean;
  enableOverflowComponents?: boolean;
  placement: 'body' | 'modal';
  showDNDSelection?: boolean;
  showDottedSelection?: boolean;
  showErrors?: boolean;
...
export type GridField = {
  ...
  isDynamic: boolean;
  isFiltered: boolean;
  conditionFilters?: FieldConditionFiltersResult;
