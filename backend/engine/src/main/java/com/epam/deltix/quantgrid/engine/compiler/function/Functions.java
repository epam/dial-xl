...
public class Functions {
    ...
    private final List<Function> FUNCTIONS = List.of(
            ...
            new Function("CONTAINS", "Return true if a text contains another text",
                    ...
                    new Argument("substring", "is the substring to check for")),
            ...
            new Function("RowReference", "Find a row by scalar values", List.of(TABLE),
                    new Argument("value", "scalar value", true)),
            ...
            new Function("RECALL", "Calculates the recall metric for the retriever based on the ground truth",
                    ...
                    new Argument("ground_truth", "The ground truth string with \";\" as the separator for items", false))
    );
