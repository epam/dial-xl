...
class TestExcelDateTime {
    ...
    void testDateTimeFromString() {
        ...
        assertDoubles(from(LocalDateTime.of(2022, 4, 10, 0,0,0, 500_000_000)), fromDateTime("2022-04-10 00:00:00.5"));
        assertDoubles(from(LocalDateTime.of(2022, 4, 10, 0,0,0, 123_456_789)), fromDateTime("2022-04-10 00:00:00.123456789"));
    }
