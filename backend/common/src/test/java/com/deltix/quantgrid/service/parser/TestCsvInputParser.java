package com.deltix.quantgrid.service.parser;
...
class TestCsvInputParser {
    ...
    void testInvalidCsvSchemaInference() {
        ...
        RuntimeException exception =
                Assertions.assertThrows(RuntimeException.class, () -> CsvInputParser.inferSchema(csvReader, true));
    ...
    void testParsingNonUtf8Chars() {
        ...
        LinkedHashMap<String, ColumnType> schema =
                CsvInputParser.inferSchema(new InputStreamReader(new ByteArrayInputStream(bytesCsv)), true);
