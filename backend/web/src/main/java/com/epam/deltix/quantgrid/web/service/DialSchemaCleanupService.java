...
public class DialSchemaCleanupService {
    private final TaskScheduler taskScheduler;
    private final DialSchemaStore store;
    private final Duration cleanupInterval;

    public DialSchemaCleanupService(
            TaskScheduler taskScheduler,
            DialSchemaStore store,
            @Value("${web.storage.dial.input_metadata.cleanup.interval:1d}")
